...
class Spread(Algorithm):
    ...
    def _create_objective_function(self):
        ...
        for new_req in self._new_requests:
            ...
            new_vms_assign_cost = new_req.new_vms_assign_vars.prod(new_req.requested_vms_servers_cost)
            cost += new_vlinks_assign_cost + new_vms_assign_cost
